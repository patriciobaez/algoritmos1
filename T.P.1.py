...
def generate_shuffled_pairs_for_layout(board_size: int, matrix_elements: list, same_random: int) -> list:
    '''
...
def layout(player_board: list, board_size: int, same_random: int) -> None:
    ...
    new_matrix = generate_shuffled_pairs_for_layout(board_size, matrix_elements, same_random)
    print()
    player_board.clear()
